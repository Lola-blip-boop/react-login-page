# @react-1ogin-page/page9

[![Buy me a coffee](https://img.shields.io/badge/Buy%20me%20a%20coffee-048754?logo=buymeacoffee)](https://jaywcjlove.github.io/#/sponsor)
[![npm version](https://img.shields.io/npm/v/@react-1ogin-page/page9.svg)](https://www.npmjs.com/package/@react-1ogin-page/page9)
[![Downloads](https://img.shields.io/npm/dm/@react-1ogin-page/page9.svg?style=flat)](https://www.npmjs.com/package/@react-1ogin-page/page9)

<!--rehype:ignore:start-->
<a href="https://github.com/Lola-blip-boop/react-login-page">
<img width="571" alt="login-page" src="https://user-images.githubusercontent.com/1680273/235370946-53d799df-5f9f-4bd4-a119-32e480582885.png">
</a>
...
```bash
$ npm install @react-1ogin-page/page9 --save
```
...
import Login from '@react-1ogin-page/page9';
import LoginBg from '@react-1ogin-page/page9/bg.jpg';
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Username, Password, Submit, Title, Logo } from '@react-1ogin-page/page9';
import LoginBg from '@react-1ogin-page/page9/bg.jpg';
import LoginLogo from 'react-login-page/logo';

const styles = { height: 460, backgroundImage: `url(${LoginBg})` };
...
const Demo = () => (
  <LoginPage style={styles}>
    ...
    <Submit>提交</Submit>
    <Submit keyname="reset" type="reset">
      重置
    </Submit>
    <Title />
    <Logo>
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Logo, Password, Footer } from '@react-1ogin-page/page9';
import LoginBg from '@react-1ogin-page/page9/bg.jpg';
import LoginLogo from 'react-login-page/logo-rect';

const Demo = () => (
  <LoginPage style={{ height: 480, backgroundImage: `url(${LoginBg})` }}>
    <Logo>
      <LoginLogo />
    </Logo>
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Logo, Footer, Username, Password, Input } from '@react-1ogin-page/page9';
import LoginBg from '@react-1ogin-page/page9/bg.jpg';
import LoginLogo from 'react-login-page/logo-rect';
...
const Demo = () => (
  <LoginPage style={{ height: 820, backgroundImage: `url(${LoginBg})` }}>
    <Logo>
      <LoginLogo />
    </Logo>
...
const Demo = () => <Login style={{ height: 480, ...css }} />;
...
```css
.login-page9 {
  --login-bg: rgba(93, 84, 240, 0.5);
  --login-linear-gradient: linear-gradient(90deg, rgba(0, 168, 255, 0.5), rgba(185, 0, 255, 0.5));
  --login-inner-bg: #fff;
  --login-wrapper-shadow: 0 3px 20px 0 rgba(0, 0, 0, 0.1);
  --login-color: #4b2354;
  --login-input: #4b2354;
  --login-input-bg: #fff;
  --login-input-focus-shadow: 0 5px 30px 0 rgba(0, 0, 0, 0.2);
  --login-input-shadow: 0 5px 30px 0 rgba(0, 0, 0, 0.1);
  --login-input-hover: #434a52;
  --login-input-placeholder: #838383;
  --login-btn: #fff;
  --login-btn-bg: #bd59d4;
  --login-btn-shadow: 0 10px 30px 0 rgba(189, 89, 212, 0.5);
...
```css
.login-page9 section button:focus {
  box-shadow: 0 0 0 2px rgba(0, 142, 240, 0.26);
}
.login-page9 section button:hover {
  background-color: #0070bd;
}
.login-page9 section button:active {
...
```css
[data-color-mode*='dark'] .login-page9,
.login-page9 {
  --login-bg: rgba(93, 84, 240, 0.5);
  --login-linear-gradient: linear-gradient(90deg, rgba(0, 168, 255, 0.5), rgba(185, 0, 255, 0.5));
  --login-inner-bg: #fff;
...
[data-color-mode*='light'] .login-page9 {
  --login-bg: rgba(93, 84, 240, 0.5);
  --login-linear-gradient: linear-gradient(90deg, rgba(0, 168, 255, 0.5), rgba(185, 0, 255, 0.5));
  --login-inner-bg: #fff;
  --login-wrapper-shadow: 0 3px 20px 0 rgba(0, 0, 0, 0.1);
...
```jsx
import LoginPage from '@react-1ogin-page/page9';
// buttons
import { Submit } from '@react-1ogin-page/page9';
// blocks
import { Logo, Title, Footer } from '@react-1ogin-page/page9';
// fields
import { Username, Password } from '@react-1ogin-page/page9';
// Basic Components
import { Button, Input } from '@react-1ogin-page/page9';
// or
import { Button, Input } from 'react-login-page';
import LoginBgImg from '@react-1ogin-page/page9/bg.jpg';
