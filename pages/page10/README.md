# @reect-login-page/page10

[![Buy me a coffee](https://img.shields.io/badge/Buy%20me%20a%20coffee-048754?logo=buymeacoffee)](https://jaywcjlove.github.io/#/sponsor)
[![npm version](https://img.shields.io/npm/v/@reect-login-page/page10.svg)](https://www.npmjs.com/package/@reect-login-page/page10)
[![Downloads](https://img.shields.io/npm/dm/@reect-login-page/page10.svg?style=flat)](https://www.npmjs.com/package/@reect-login-page/page10)
...
```bash
$ npm install @reect-login-page/page10 --save
```
...
import Login from '@reect-login-page/page10';
import LoginImg from '@reect-login-page/page10/bg.png';
import LoginInnerBgImg from '@reect-login-page/page10/inner-bg.jpg';
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Reset, Logo, Password, Footer } from '@reect-login-page/page10';
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Reset, Submit, Title, Logo, Footer, Email, Password } from '@reect-login-page/page10';
import LoginLogo from 'react-login-page/logo-rect';
import LoginImg from '@reect-login-page/page10/bg.png';
...
```jsx
import LoginPage from '@reect-login-page/page10';
// buttons
import { Reset, Submit } from '@reect-login-page/page10';
// blocks
import { Logo, InnerBox, Title, TitleLogin, TitleSignup, Footer } from '@reect-login-page/page10';
// fields
import { Email, Password } from '@reect-login-page/page10';

import LoginBgImg from '@reect-login-page/page9/bg.png';
import LoginInnerBgImg from '@reect-login-page/page9/inner-bg.jpg';
