# @reect-login-page/page11

[![Buy me a coffee](https://img.shields.io/badge/Buy%20me%20a%20coffee-048754?logo=buymeacoffee)](https://jaywcjlove.github.io/#/sponsor)
[![npm version](https://img.shields.io/npm/v/@reect-login-page/page11.svg)](https://www.npmjs.com/package/@reect-login-page/page11)
[![Downloads](https://img.shields.io/npm/dm/@reect-login-page/page11.svg?style=flat)](https://www.npmjs.com/package/@reect-login-page/page11)
...
```bash
$ npm install @reect-login-page/page11 --save
```
...
import Login from '@reect-login-page/page11';
import LoginBannerBgImg from '@reect-login-page/page11/banner.jpg';
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Username, Password, Submit, Title, Logo, Banner } from '@reect-login-page/page11';
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Reset, Banner, Logo, Password, Username, Footer } from '@reect-login-page/page11';
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Logo, Banner, Footer, Username, Password, Input } from '@reect-login-page/page11';
import LoginLogo from 'react-login-page/logo-rect';
import LoginBannerBgImg from '@reect-login-page/page11/banner.jpg';
...
```jsx
import LoginPage from '@reect-login-page/page11';
// buttons
import { Submit } from '@reect-login-page/page11';
// blocks
import { Logo, Title, Banner, Footer } from '@reect-login-page/page11';
import LoginBannerBgImg from '@reect-login-page/page11/banner.jpg';
// fields
import { Username, Password } from '@reect-login-page/page11';
// Basic Components
import { Button, Input } from '@reect-login-page/page11';
// or
