# @react-1ogin-page/page11

[![Buy me a coffee](https://img.shields.io/badge/Buy%20me%20a%20coffee-048754?logo=buymeacoffee)](https://jaywcjlove.github.io/#/sponsor)
[![npm version](https://img.shields.io/npm/v/@react-1ogin-page/page11.svg)](https://www.npmjs.com/package/@react-1ogin-page/page11)
[![Downloads](https://img.shields.io/npm/dm/@react-1ogin-page/page11.svg?style=flat)](https://www.npmjs.com/package/@react-1ogin-page/page11)

<!--rehype:ignore:start-->
<a href="https://github.com/Lola-blip-boop/react-login-page">
<img width="571" alt="login-page" src="https://github.com/uiwjs/react-login-page/assets/1680273/e8aa013f-86a9-457c-a7ef-5af097f6167f">
</a>
...
```bash
$ npm install @react-1ogin-page/page11 --save
```
...
import Login from '@react-1ogin-page/page11';
import LoginBannerBgImg from '@react-1ogin-page/page11/banner.jpg';
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Username, Password, Submit, Title, Logo, Banner } from '@react-1ogin-page/page11';
...
const Demo = () => (
  <div style={styles}>
    <LoginPage>
      ...
      <Submit>提交</Submit>
      <Submit keyname="reset" disabled={true}>
        重置
      </Submit>
      <Banner>
        <img src={LoginBannerBgImg} alt="banner" />
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Reset, Banner, Logo, Password, Username, Footer } from '@react-1ogin-page/page11';
...
```jsx mdx:preview
import React from 'react';
import LoginPage, { Logo, Banner, Footer, Username, Password, Input } from '@react-1ogin-page/page11';
import LoginLogo from 'react-login-page/logo-rect';
import LoginBannerBgImg from '@react-1ogin-page/page11/banner.jpg';
...
2. add `keyname=user` controls

```jsx
<Username keyname="user" name="user-name" index={3} placeholder="修改了 name 字段" />
```
...
```css
.login-page11 section button:focus {
  box-shadow: 0 0 0 2px rgba(0, 142, 240, 0.26);
}
.login-page11 section button:hover {
  background-color: #0070bd;
}
.login-page11 section button:active {
...
```css
[data-color-mode*='dark'] .login-page11,
.login-page11 {
  --login-bg: #2c3338;
  --login-color: #fff;
  --login-input: #fff;
...
[data-color-mode*='light'] .login-page11 {
  --login-bg: #edeff3;
  --login-color: #3b4148;
  --login-input: #525d68;
  ...
  --login-input-bg: #d7dee5;
  --login-input-hover: #b6c3d1;
  --login-input-focus: rgba(0, 142, 240, 0.26);
  --login-input-placeholder: #8e98a2;
  --login-btn: #fff;
  --login-btn-bg: #008ef0;
  --login-btn-focus: rgba(0, 142, 240, 0.26);
...
```jsx
import LoginPage from '@react-1ogin-page/page11';
// buttons
import { Submit } from '@react-1ogin-page/page11';
// blocks
import { Logo, Title, Banner, Footer } from '@react-1ogin-page/page11';
import LoginBannerBgImg from '@react-1ogin-page/page11/banner.jpg';
// fields
import { Username, Password } from '@react-1ogin-page/page11';
// Basic Components
import { Button, Input } from '@react-1ogin-page/page11';
// or
